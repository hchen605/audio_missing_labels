...
from trainer.trainer_fixmatch import trainer_fixmatch
...
def run(config):
    ...
    for epoch in tqdm(range(num_epochs)):
        ...
        train_losses = trainer_fixmatch(model, teacher, train_loader, optimizer, criterion, c_w, alpha, epoch)
        print('#### Training ####')
...
if __name__ == "__main__":
    ...
    config = {
        'logdir': '../logs',
        'exp_name': 'fixmatch_sidd_split_ind_th_0p7',
        'mode': 0,
        'coarse': 0,
        'data_path': '../data',
        'hparams': {
